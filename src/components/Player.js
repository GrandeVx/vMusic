...
const Player = ({ songs , setsongs, currentSong , setCurrentSong , isPlaying,setIsPlaying, audioRef,songInfo,setSongInfo}) => {
    ...
    const skipTrackHandler = async (direction) => {
        ...
        // otteniamo l'indice nel vettore di canzoni 
        ...
        if (direction === 'skip-forward') {
            ...
            if (currenIndex === 0) await setCurrentSong(songs[songs.length - 1]);
            else await setCurrentSong(songs[(currenIndex -1) % songs.length]);
        }
    ...
    return(
        ...
        <div className="player">
                ...
                <div className="play-control">
                    ...
                    <FontAwesomeIcon onClick={() => skipTrackHandler('skip-forward')} className="skip-forword" icon={faAngleRight} size="2x"/>
                </div>
